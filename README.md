...
* Must use a database (you choose) - Supabase
* Must have interactive UI (of any kind) - React + MUI
* Must use a library or framework not discussed/used in class - Spotify API
* Must use an outside REST API in some way (Outside as in external, like the Reddit API, etc) - Spotify API
